...
public class DialogRecherche extends AlertDialog.Builder {
	...
	public DialogRecherche(Context arg0, String titre, String color,String image ) {
		super(arg0);
	...
	private void defined_interface() {
		...
		this.setPositiveButton("Lancer", new DialogInterface.OnClickListener() {
			public void onClick(DialogInterface dialog, int id) {
				try {
					String url = DialogRecherche.this.defined_url();
					Log.d("ASI","url-"+url);
					Intent i = new Intent(mContext, ActivityListArticleRecherche.class);
					...
					new DialogError(mContext, "Chargement de la recherche d'articles", e)
							.show();
					dialog.cancel();
				}
